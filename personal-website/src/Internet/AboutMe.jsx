    ...
    return (
        <div className="bg-[#f7c2a7]">
            <p className="text-[13px] leading-6 text-black font-bold">
                I'm a Nanotechnology Engineer turned Software Engineer based in Toronto, Canada, passionate about building data-driven, future-proof applications that make a real impact.
                <br />
                <br />
